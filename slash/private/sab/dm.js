module.exports = {
	...
	async execute(interaction, args, client, Client, Discord) {
		if (interaction.guild_id == '661736128373719141') if (!client.guilds.cache.get('661736128373719141').members.cache.get(interaction.member.user.id).roles.cache.has('699724468469366844')) return;
